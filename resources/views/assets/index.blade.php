                                        ...
                                        <div class="px-7 py-5" data-kt-user-table-filter="form">
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <select
                                                    ...
                                                    data-hide-search="true" data-select2-id="select2-data-1-f8vh"
                                                    ...
                                                    dir="ltr" data-select2-id="select2-data-2-d1k8"
                                                    style="width: 100%;"><span class="selection"><span
                                                            ...
                                                            aria-controls="select2-45qw-container"><span
                                                                ...
                                                                id="select2-45qw-container" role="textbox"
                                            ...
                                            <div class="mb-10">
                                                ...
                                                <select
                                                    ...
                                                    data-hide-search="true" data-select2-id="select2-data-4-vakf"
                                                    tabindex="-1" aria-hidden="true" data-kt-initialized="1">
                                                    <option data-select2-id="select2-data-6-xnp9"></option>
                                                    <option value="Enabled">Enabled</option>
                                                </select><span
                                                    class="select2 select2-container select2-container--bootstrap5"
                                                    dir="ltr" data-select2-id="select2-data-5-ml7p"
                                                    style="width: 100%;"><span class="selection"><span
                                                            class="select2-selection select2-selection--single form-select form-select-solid fw-bold"
                                                            role="combobox" aria-haspopup="true" aria-expanded="false"
                                                            tabindex="0" aria-disabled="false"
                                                            ...
                                                            aria-controls="select2-l3k4-container"><span
                                                                class="select2-selection__rendered"
                                                                id="select2-l3k4-container" role="textbox"
                                                                aria-readonly="true" title="Select option"><span
                                                                    class="select2-selection__placeholder">Select
                                                                    option</span></span><span
                                                                class="select2-selection__arrow" role="presentation"><b
                            ...
                            <div id="kt_table_users_wrapper" class="dt-container dt-bootstrap5 dt-empty-footer">
                                <div id="" class="table-responsive">
                                    <table class="table align-middle table-row-dashed fs-6 gy-4 dataTable"
                                        id="kt_table_users" style="width: 1533.5px;">
                                        <thead>
        ...
        `;
...

                        {
                            ...
                            render: function(data) {
                                ...
                                if (data === 'b') {
                                    return `<span class="badge bg-light-danger">Broken</span>`;
                                }
