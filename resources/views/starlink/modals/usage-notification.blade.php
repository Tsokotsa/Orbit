        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                ...
                <form method="POST" action="/notifications/store" class="form" id="kt_modal_new_target_form">
                    ...
                    <!-- Service ID to Link -->
                    <!-- ===================== -->
                    <label class="required fs-6 fw-semibold mb-2">Service ID</label>
                    <select id="service_id" class="form-select form-select-solid pb-4" name="service_id"></select>

                    <!-- ===================== -->
                    <!-- Threshold -->
                    <!-- ===================== -->
                    <div class="mb-8 mt-8 fv-row">
