...
@section('content')
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
                    ...
                    <form id="kt_modal_new_target_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#"
                        ...
                        <div class="d-flex flex-column mb-8 fv-row">
                            ...
                            <tags class="tagify  form-control form-control-solid" tabindex="-1">
                                <tag title="Important" contenteditable="false" tabindex="-1"
            ...
            <div class="card mb-5 mb-xl-10" id="assets" role="tabpanel">
                <!--begin::Card header-->
                <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                    ...
                    <div class="card-title m-0">
                        <h3 class="fw-bold m-0">Client Assets</h3>
                    </div>
                    <!--end::Card title-->
                </div>
                <!--begin::Card header-->
