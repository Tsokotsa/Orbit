...
<body id="kt_app_body" data-kt-app-header-fixed="true" data-kt-app-header-fixed-mobile="true"
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            ...
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                ...
                <!-- Include Tsokotsa Includes -->
                @include('includes.sidebar')

                @include('includes.modals.compose-sms')
                @include('includes.modals.sms.test-sms')
                @include('includes.modals.email.test-email')
                @include('includes.modals.telegram.test-telegram')
    ...
    @if (session('reload'))
        <script>
            // Force a full reload if session indicates a logout redirect
