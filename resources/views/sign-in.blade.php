...
<head>
    ...
    <meta charset="utf-8" />
    <meta name="description" content="Notify in various ways" />
    <meta name="keywords" content="We will reach everyone, Email, Telegram, Text Message and more" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <meta property="og:locale" content="en_US" />
    <meta property="og:type" content="article" />
    <meta property="og:title" content="Orbit - Arround all Universe" />
    <meta property="og:url" content="https://paratus.co.mz" />
                    ...
                    <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                            ...
                            <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" method="POST" action="{{ route('login') }}" data-kt-redirect-url="/land">
                                ...
                                <div class="fv-row mb-8">
                                    ...
                                    <input type="text" placeholder="email" name="email" autocomplete="off"
                                        id="username" class="form-control bg-transparent" />
                                    <!--end::Username-->
                                </div>
                                <!--end::Input group=-->
                                ...
                                <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                                    <div></div>
                                    <!--begin::Link-->
                                    <a href="/forgotpass" class="link-primary">Forgot Password ?</a>
                                    <!--end::Link-->
                                </div>
                                <!--end::Wrapper-->
                                <!--begin::Submit button-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex fw-semibold text-primary fs-base gap-5">
                                ...
                                <a href="https://paratus.co.mz" target="_blank">Contact Us</a>
                            </div>
                            <!--end::Links-->
                        </div>
                        <!--end::Footer-->
