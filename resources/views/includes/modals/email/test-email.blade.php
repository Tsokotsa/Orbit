            ...
            <div class="modal-body">
                ...
                <form id="kt_inbox_compose_form" class="test_email_form"> 
                    ...
                    <div class="d-block">
                        ...
                        <!--end::To-->
                        <!--begin::CC-->
                        <div class="align-items-center border-bottom ps-8 pe-5 min-h-50px d-none" data-kt-inbox-form="cc">
                            <!--begin::Label-->
                        ...
                        <!--end::CC-->
                        <!--begin::BCC-->
                        <div class="align-items-center border-bottom inbox-to-bcc ps-8 pe-5 min-h-50px d-none" data-kt-inbox-form="bcc">
                            <!--begin::Label-->
                        ...
                        <!--end::Subject-->
                        <!--begin::Message-->
                        <div id="compose_email_editor2"  class=" h-350px">
                        </div>
