                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-center flex-column py-5">
                                    ...
                                    <div class="symbol symbol-100px symbol-circle mb-7">
                                        <img @if($user->avatarpath) { src="{{ asset($user->avatarpath["file_path"].'/' .$user->avatarpath["file_name"]) }}" } @else { src="{{ asset('assets/media/avatars/blank.png') }}" } @endif alt="avatar">
                                    </div>
                                    <!--end::Avatar-->
                                    <!--begin::Name-->
                                    ...
                                    <div class="mb-9">
                                        <!--begin::Badge-->
                                        <div class="badge badge-lg badge-light-primary d-inline">{{ $user->roles[0]['name'] ?? "Role not defined" }}</div>
                                        <!--begin::Badge-->
                                    </div>
                                    <!--end::Position-->
                                    <!--begin::Info-->
                                ...
                                <div class="d-flex flex-stack fs-4 py-3">
                                    <div class="fw-bold rotate collapsible collapsed" data-bs-toggle="collapse" href="#kt_user_view_details" role="button" aria-expanded="false" aria-controls="kt_user_view_details">Details 
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid">
                                                    ...
                                                    <label class="form-check-label" for="kt_modal_update_email_notification_0">
                                                        ...
                                                        <div class="text-gray-600">Receive notification for any new campaign created.</div>
                                                    </label>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Checkbox-->
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid">
                                                    ...
                                                    <label class="form-check-label" for="kt_modal_update_email_notification_1">
                                                        ...
                                                        <div class="text-gray-600">If new account is added on the system.</div>
                                                    </label>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Checkbox-->
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="form-check form-check-custom form-check-solid">
                                                    ...
                                                    <label class="form-check-label" for="kt_modal_update_email_notification_2">
                                                        ...
                                                        <div class="text-gray-600">Autommated notifications generated by the system.</div>
                                                    </label>
                                                    <!--end::Label-->
                                                </div>
                                                <!--end::Checkbox-->
                                        ...
                                        <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">22 Sep 2024, 2:40 pm</td>
                                                </tr>
                                                <tr>
                                                    <td class="min-w-400px">
                                                    <a href="#" class="text-gray-600 text-hover-primary me-1">Sean Bean</a>has made payment to 
                                                ...
                                                <tr>
                                                    ...
                                                    <a href="#" class="text-gray-600 text-hover-primary me-1">Max Smith</a>has made payment to 
                                                    <a href="#" class="fw-bold text-gray-900 text-hover-primary">#SDK-45670</a></td>
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">21 Feb 2024, 8:43 pm</td>
                                                </tr>
                                                <tr>
                                                    <td class="min-w-400px">Invoice 
